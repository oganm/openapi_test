  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`bioAssays`)) {
        self$`bioAssays` <- ApiClient$new()$deserializeObj(this_object$`bioAssays`, "array[integer]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`characteristics`)) {
        self$`characteristics` <- ApiClient$new()$deserializeObj(this_object$`characteristics`, "array[CharacteristicValueObject]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`description`)) {
        self$`description` <- this_object$`description`
      }
      if (!is.null(this_object$`factorIdToFactorValueId`)) {
        self$`factorIdToFactorValueId` <- ApiClient$new()$deserializeObj(this_object$`factorIdToFactorValueId`, "map(character)", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`factors`)) {
        self$`factors` <- ApiClient$new()$deserializeObj(this_object$`factors`, "map(character)", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`factorValueObjects`)) {
        self$`factorValueObjects` <- ApiClient$new()$deserializeObj(this_object$`factorValueObjects`, "array[IdentifiableValueObject]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`factorValues`)) {
        self$`factorValues` <- ApiClient$new()$deserializeObj(this_object$`factorValues`, "map(character)", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`characteristicValues`)) {
        self$`characteristicValues` <- ApiClient$new()$deserializeObj(this_object$`characteristicValues`, "map(character)", loadNamespace("openapi"))
      }
      self
    },
    #' To JSON string
