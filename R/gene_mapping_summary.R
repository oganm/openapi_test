  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`geneProductIdMap`)) {
        self$`geneProductIdMap` <- ApiClient$new()$deserializeObj(this_object$`geneProductIdMap`, "map(GeneProductValueObject)", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`geneProductIdGeneMap`)) {
        self$`geneProductIdGeneMap` <- ApiClient$new()$deserializeObj(this_object$`geneProductIdGeneMap`, "map(GeneValueObject)", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`geneProductMap`)) {
        self$`geneProductMap` <- ApiClient$new()$deserializeObj(this_object$`geneProductMap`, "map(GeneValueObject)", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`geneProducts`)) {
        self$`geneProducts` <- ApiClient$new()$deserializeObj(this_object$`geneProducts`, "array[GeneProductValueObject]", loadNamespace("openapi"))
      }
      self
    },
    #' To JSON string
