  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`annotations`)) {
        self$`annotations` <- ApiClient$new()$deserializeObj(this_object$`annotations`, "set[Characteristic]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`meshTerms`)) {
        self$`meshTerms` <- ApiClient$new()$deserializeObj(this_object$`meshTerms`, "set[MedicalSubjectHeading]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`keywords`)) {
        self$`keywords` <- ApiClient$new()$deserializeObj(this_object$`keywords`, "set[Keyword]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`chemicals`)) {
        self$`chemicals` <- ApiClient$new()$deserializeObj(this_object$`chemicals`, "set[Compound]", loadNamespace("openapi"))
      }
      self
    },
    #' To JSON string
