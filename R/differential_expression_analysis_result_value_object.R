  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`genes`)) {
        self$`genes` <- ApiClient$new()$deserializeObj(this_object$`genes`, "array[GeneValueObject]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`contrasts`)) {
        self$`contrasts` <- ApiClient$new()$deserializeObj(this_object$`contrasts`, "array[ContrastResultValueObject]", loadNamespace("openapi"))
      }
