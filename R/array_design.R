  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`alternateNames`)) {
        self$`alternateNames` <- ApiClient$new()$deserializeObj(this_object$`alternateNames`, "set[AlternateName]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`compositeSequences`)) {
        self$`compositeSequences` <- ApiClient$new()$deserializeObj(this_object$`compositeSequences`, "set[CompositeSequence]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`externalReferences`)) {
        self$`externalReferences` <- ApiClient$new()$deserializeObj(this_object$`externalReferences`, "set[DatabaseEntry]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`mergees`)) {
        self$`mergees` <- ApiClient$new()$deserializeObj(this_object$`mergees`, "set[ArrayDesign]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`subsumedArrayDesigns`)) {
        self$`subsumedArrayDesigns` <- ApiClient$new()$deserializeObj(this_object$`subsumedArrayDesigns`, "set[ArrayDesign]", loadNamespace("openapi"))
      }
