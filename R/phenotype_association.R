  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`phenotypes`)) {
        self$`phenotypes` <- ApiClient$new()$deserializeObj(this_object$`phenotypes`, "set[Characteristic]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`phenotypeAssociationPublications`)) {
        self$`phenotypeAssociationPublications` <- ApiClient$new()$deserializeObj(this_object$`phenotypeAssociationPublications`, "set[PhenotypeAssociationPublication]", loadNamespace("openapi"))
      }
