  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`aliases`)) {
        self$`aliases` <- ApiClient$new()$deserializeObj(this_object$`aliases`, "array[character]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`geneSets`)) {
        self$`geneSets` <- ApiClient$new()$deserializeObj(this_object$`geneSets`, "array[GeneSetValueObject]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`homologues`)) {
        self$`homologues` <- ApiClient$new()$deserializeObj(this_object$`homologues`, "array[GeneValueObject]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`nodeDegreeNegRanks`)) {
        self$`nodeDegreeNegRanks` <- ApiClient$new()$deserializeObj(this_object$`nodeDegreeNegRanks`, "array[numeric]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`nodeDegreePosRanks`)) {
        self$`nodeDegreePosRanks` <- ApiClient$new()$deserializeObj(this_object$`nodeDegreePosRanks`, "array[numeric]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`nodeDegreesNeg`)) {
        self$`nodeDegreesNeg` <- ApiClient$new()$deserializeObj(this_object$`nodeDegreesNeg`, "array[integer]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`nodeDegreesPos`)) {
        self$`nodeDegreesPos` <- ApiClient$new()$deserializeObj(this_object$`nodeDegreesPos`, "array[integer]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`phenotypes`)) {
        self$`phenotypes` <- ApiClient$new()$deserializeObj(this_object$`phenotypes`, "array[CharacteristicValueObject]", loadNamespace("openapi"))
      }
