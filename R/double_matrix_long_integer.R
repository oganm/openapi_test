  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`colNames`)) {
        self$`colNames` <- ApiClient$new()$deserializeObj(this_object$`colNames`, "array[integer]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`rowNames`)) {
        self$`rowNames` <- ApiClient$new()$deserializeObj(this_object$`rowNames`, "array[integer]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`rawMatrix`)) {
        self$`rawMatrix` <- ApiClient$new()$deserializeObj(this_object$`rawMatrix`, "array[array[numeric]]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`columnNames`)) {
        self$`columnNames` <- ApiClient$new()$deserializeObj(this_object$`columnNames`, "array[integer]", loadNamespace("openapi"))
      }
