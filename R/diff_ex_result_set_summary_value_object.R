  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`arrayDesignsUsed`)) {
        self$`arrayDesignsUsed` <- ApiClient$new()$deserializeObj(this_object$`arrayDesignsUsed`, "array[integer]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`experimentalFactors`)) {
        self$`experimentalFactors` <- ApiClient$new()$deserializeObj(this_object$`experimentalFactors`, "array[ExperimentalFactorValueObject]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`factorIds`)) {
        self$`factorIds` <- ApiClient$new()$deserializeObj(this_object$`factorIds`, "array[integer]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`experimentalFactorsByValueObject`)) {
        self$`experimentalFactorsByValueObject` <- ApiClient$new()$deserializeObj(this_object$`experimentalFactorsByValueObject`, "array[ExperimentalFactorValueObject]", loadNamespace("openapi"))
      }
      self
    },
    #' To JSON string
