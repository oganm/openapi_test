  ...
  public = list(
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`products`)) {
        self$`products` <- ApiClient$new()$deserializeObj(this_object$`products`, "set[GeneProduct]", loadNamespace("openapi"))
      }
      if (!is.null(this_object$`aliases`)) {
        self$`aliases` <- ApiClient$new()$deserializeObj(this_object$`aliases`, "set[GeneAlias]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`accessions`)) {
        self$`accessions` <- ApiClient$new()$deserializeObj(this_object$`accessions`, "set[DatabaseEntry]", loadNamespace("openapi"))
      }
      ...
      if (!is.null(this_object$`phenotypeAssociations`)) {
        self$`phenotypeAssociations` <- ApiClient$new()$deserializeObj(this_object$`phenotypeAssociations`, "set[PhenotypeAssociation]", loadNamespace("openapi"))
      }
      self
    },
    #' To JSON string
