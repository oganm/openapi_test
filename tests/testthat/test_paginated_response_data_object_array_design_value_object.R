...
context("Test PaginatedResponseDataObjectArrayDesignValueObject")

model_instance <- PaginatedResponseDataObjectArrayDesignValueObject$new()

test_that("data", {
  # tests for the property `data` (array[ArrayDesignValueObject])
