...
context("Test PaginatedResponseDataObjectCompositeSequenceValueObject")

model_instance <- PaginatedResponseDataObjectCompositeSequenceValueObject$new()

test_that("data", {
  # tests for the property `data` (array[CompositeSequenceValueObject])
